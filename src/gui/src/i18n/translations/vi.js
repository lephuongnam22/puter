...
const vi = {
    ...
    dictionary: {
        ...
        "billing.paid": "Trả", // In English: "Paid"
        ...
        "billing.offering.business": "Doan nhân", // In English: "Business"
        "billing.cloud_storage": "Lưu trữ đám mây", // In English: "Cloud Storage"
        "billing.ai_access": "", // In English: "AI Access"
        ...
        "billing.switch_to": "Chuyển đổi tới %string%", // In English: "Switch to %strong%"
        "billing.payment_setup": "Cài đặt thanh toán", // In English: "Payment Setup"
        "billing.back": "Quay trở lại", // In English: "Back"
        "billing.you_are_now_subscribed_to": "Bạn đã đăng ký tới tầng %string%", // In English: "You are now subscribed to %strong% tier."
        ...
        "billing.cancel_it": "Hủy cái này đi", // In English: "Cancel It"
        "billing.keep_it": "Tiếp tục giữ nó", // In English: "Keep It"
        "billing.subscription_resumed": "Đăng ký %string% của bạn đã được tiếp tục !", // In English: "Your %strong% subscription has been resumed!"
        ...
        "billing.download_receipt": "Tải xuống biên lai", // In English: "Download Receipt"
        ...
        "billing.email_confirmation_needed": "Email của bạn vẫn chưa được xác nhận. Bạn sẽ được gửi một mã code để xác nhận email.", // In English: "Your email has not been confirmed. We'll send you a code to confirm it now."
        "billing.sub_cancelled_but_valid_until": "Bạn đã hủy đăng ký và nó sẽ được chuyển đổi sang gói miễn phí một cách tự động sau khi kết thúc thời hạn thanh toán. Bạn sẽ không bị tính phí cho đến khi bạn đăng ký lại.", // In English: "You have cancelled your subscription and it will automatically switch to the free tier at the end of the billing period. You will not be charged again unless you re-subscribe."
